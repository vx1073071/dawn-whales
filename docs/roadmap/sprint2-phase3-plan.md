...
quant-moo currently operates with a **single broker backend**: Futu OpenD. All market data, order routing, and account management flow through a single `FutuOpenDClient` instance. This limits users to Futu-supported markets and a single account.
