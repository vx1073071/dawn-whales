...
DAWN WHALES supports multiple broker integrations through a unified adapter interface. This document describes the architecture for multi-broker support, enabling users to connect to different trading platforms while maintaining a consistent API.
