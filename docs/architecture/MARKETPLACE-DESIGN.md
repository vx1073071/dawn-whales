...
| 策略等级 | 价格区间 | 平台抽成 | 创作者收入 |
|---------|---------|---------|-----------|
| 免费策略 | ¥0 | ¥0 | ¥0（引流） |
| 入门策略 | ¥9.9-29.9/月 | 30% | ¥6.9-20.9/月 |
| 进阶策略 | ¥49.9-99.9/月 | 30% | ¥34.9-69.9/月 |
| 专业策略 | ¥199-499/月 | 30% | ¥139-349/月 |
| 定制策略 | 议价 | 20% | 80% |
...
CREATE TABLE verified_performance (
  ...
  nav REAL,                         -- 净值
  is_live BOOLEAN DEFAULT TRUE      -- 实盘 vs 回测
);
...
CREATE TABLE revenue_shares (
  ...
  amount REAL,                      -- 总收入
  platform_share REAL,              -- 平台30%
  author_share REAL,                -- 作者70%
...
| 阶段 | 策略数 | 付费订阅 | 月收入 | 平台抽成 |
|------|-------|---------|--------|---------|
| Phase 6 上线 | 50 | 100 | ¥9,900 | ¥2,970 |
| 6个月后 | 200 | 500 | ¥49,500 | ¥14,850 |
| 12个月后 | 500 | 2,000 | ¥198,000 | ¥59,400 |
| 24个月后 | 2,000 | 10,000 | ¥990,000 | ¥297,000 |
