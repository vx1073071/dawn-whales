...
**Date**: 2026-06-06
**Tester**: ML (EasyClaw)
**Build**: `release/DAWN WHALES Setup 0.6.0.exe` (113 MB, 07:04 GMT+8)
...
|---|------|----------|--------|
| 1 | Run `DAWN WHALES Setup 0.6.0.exe` | Installer launches | ☐ |
...
| 5 | Start menu entry created | DAWN WHALES appears | ☐ |
...
| 13 | Tray tooltip | "DAWN WHALES · 道鲸" | ☐ |
