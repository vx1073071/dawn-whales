# Dawn Whales Withdrawal Risk Control v17.6
...
Dawn Whales manages USDT withdrawals through a **6-rule risk engine** with automated routing and manual review for high-risk cases. All withdrawals are non-custodial — the user owns the destination address.
