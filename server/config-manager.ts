/**
 * QUANT MOO R129 J03 — Server Configuration Management
 * 
...
function parseAndDefaults(): ConfigSchema {
  return {
    ...
    DB_PATH: process.env.DB_PATH || path.join(process.cwd(), 'data', 'quant-moo.db'),
...
export function generateEnvTemplate(): string {
  return [
    '# QUANT MOO v2.0.0 — Server Configuration',
