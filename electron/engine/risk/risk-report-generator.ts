...
export class RiskReportGenerator {
  ...
  private generateHTML(data: RiskReportData, config: RiskReportConfig): string {
    ...
    const firm = brand.firmName ?? 'QUANT MOO';
...
<!-- Footer -->
<div class="footer">
  ${zh('Generated by QUANT MOO Risk Engine', i18n.t('riskReportGenerator.k27'))} · ${new Date().toISOString()}
  ...
  private generateMarkdown(data: RiskReportData, config: RiskReportConfig): string {
    ...
    const lines = [
      ...
      '',
      `---`,
      `*${zh('Generated by QUANT MOO Risk Engine', i18n.t('riskReportGenerator.k46'))} · ${new Date().toISOString()}*`,
    ];
