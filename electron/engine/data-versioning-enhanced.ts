...
export class DataVersioningManager {
   ...
   */
  createVersion(data: any, metadata?: Record<string, any>): DataVersion {
   ...
   */
  rollbackToVersion(version: number): { success: boolean; data?: any; error?: string } {
   ...
   */
  setData(data: any, metadata?: Record<string, any>): DataVersion {
