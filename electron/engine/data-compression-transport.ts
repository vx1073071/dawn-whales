...
export class DataCompressionTransport extends EventEmitter {
  ...
  private versions: Map<string, { data: any; version: number }> = new Map();
  private batchQueue: { channel: string; data: any }[] = [];
   ...
   */
  prepare(channel: string, data: any): CompressionResult {
