...
export class RealtimeAggregator extends EventEmitter {
  ...
  private setupEventListeners(): void {
    ...
    this.wsManager.on('quote:update', (clientId: string, data: any) => {
      this.handleQuoteUpdate(clientId, data);
    });

    this.wsManager.on('signal:update', (clientId: string, data: any) => {
      this.handleSignalUpdate(clientId, data);
    });
  }

  private handleQuoteUpdate(clientId: string, data: any): void {
  ...
  private handleSignalUpdate(clientId: string, data: any): void {
    const symbol = data.symbol;
