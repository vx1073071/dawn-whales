...
class DataQualityStreamMonitor extends EventEmitter {
  ...
  validateTick(tick: unknown): boolean {
  ...
  private validateFormat(tick: unknown): boolean {
  ...
  private validatePriceBounds(tick: unknown): boolean {
  ...
  private validateVolume(tick: unknown): boolean {
  ...
  private validateTimestamp(tick: unknown, now: number): boolean {
  ...
  private validateFreshness(tick: unknown, now: number): boolean {
