...
export class DataConsistencyChecker {
   ...
   */
  validateStockData(data: unknown[]): ConsistencyCheckResult {
   ...
   */
  private validateStockFields(stock: unknown): ConsistencyCheck[] {
    const checks: ConsistencyCheck[] = [];
   ...
   */
  validateMultiSource(sources: { name: string; data: unknown[] }[]): ConsistencyCheckResult {
    const checks: ConsistencyCheck[] = [];
