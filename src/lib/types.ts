...
export type SidebarView = 'dashboard' | 'market' | 'strategy' | 'marketplace' | 'backtest' | 'live' | 'portfolio' | 'orders' | 'risk' | 'settings' | 'trade' | 'alert' | 'ai' | 'ai-hub' | 'riskviz' | 'creator' | 'signals' | 'copytrade' | 'wallet';
