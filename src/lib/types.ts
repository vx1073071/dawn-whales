...
export type SidebarView = 'dashboard' | 'market' | 'sectorHeatmap' | 'macroDashboard' | 'stockScreener' | 'newsDashboard' | 'sectorRotation' | 'consumerDashboard' | 'marginDashboard' | 'dragonTiger' | 'capitalFlow' | 'fundHoldings' | 'dailyReport' | 'stockOverview' | 'realTimeMarket' | 'smartPicker' | 'tradeExecution' | 'tradeHistory' | 'aiAdvisor' | 'performanceAttribution' | 'regimeMonitor' | 'strategy' | 'marketplace' | 'backtest' | 'backtestComparison' | 'live' | 'portfolio' | 'portfolioRebalancer' | 'orders' | 'risk' | 'settings';
