...
export type SidebarView = 'dashboard' | 'market' | 'sectorHeatmap' | 'macroDashboard' | 'stockScreener' | 'newsDashboard' | 'sectorRotation' | 'consumerDashboard' | 'marginDashboard' | 'dragonTiger' | 'capitalFlow' | 'fundHoldings' | 'dailyReport' | 'stockOverview' | 'realTimeMarket' | 'dataQuality' | 'smartPicker' | 'tradeExecution' | 'tradeHistory' | 'aiAdvisor' | 'performanceAttribution' | 'regimeMonitor' | 'factorExposure' | 'strategy' | 'marketplace' | 'backtest' | 'backtestComparison' | 'live' | 'portfolio' | 'portfolioRebalancer' | 'orders' | 'risk' | 'settings';
