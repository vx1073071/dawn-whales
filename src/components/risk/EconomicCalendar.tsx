  ...
  return (
    <div className="bg-[#1a1a25] border border-white/5 rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-white font-semibold text-sm">{i18n.t("EconomicCalendar.r92_02bd")}</h2>
          {nextEvent &&
          <p className="text-gray-500 text-[10px] mt-0.5">{i18n.t("EconomicCalendar.r92_861c")}
            {nextEvent.country} {nextEvent.event} · {nextEvent.date.slice(5)} {nextEvent.time}
            </p>
          }
        </div>
