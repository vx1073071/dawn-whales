  ...
  return (
    <div className="p-6 space-y-5 h-full overflow-auto">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">{i18n.t("ConsumerDashboard.r92_ac4f")}</h1>
          <p className="text-gray-400 text-sm">{i18n.t("ConsumerDashboard.r92_6455")}</p>
        </div>
        <button
          onClick={fetchData}
          disabled={loading}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#1a1a25] border border-white/5 rounded-xl p-4">
            <div className="text-xs text-gray-500 mb-1">{i18n.t("ConsumerDashboard.r92_ca15")}</div>
        ...
        <div className="bg-[#1a1a25] border border-white/5 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold text-white">{(latestRetail.total / 10000).toFixed(1)}{i18n.t("ConsumerDashboard.r92_ca72")}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="bg-[#1a1a25] border border-white/5 rounded-xl p-4">
          <h2 className="text-sm font-medium text-white mb-3">{i18n.t("ConsumerDashboard.r92_e531")}</h2>
