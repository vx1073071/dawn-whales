      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            总市值: <span className="text-white font-mono">${totalValue.toLocaleString()}</span>
      ...
      {selectedTab === 'overview' && riskMetrics && (
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <span className="text-[10px] text-gray-600 bg-gray-800/60 px-2 py-0.5 rounded">
              方法: {riskMetrics.varMethod}
            </span>
          </div>
        </div>
      )}
            ...
            >
              <div>
                ...
                <div className="text-[10px] text-gray-500 mt-0.5">
                  最差资产: {test.worstAsset} ({(test.worstAssetReturn * 100).toFixed(1)}%)
                </div>
              </div>
