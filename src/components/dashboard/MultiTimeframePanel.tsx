  ...
  return (
    <div className={`bg-gray-900 rounded-xl border border-gray-800 p-5 ${className ?? ''}`}>
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-lg font-bold text-white">{i18n.t("MultiTimeframePanel.r92_9161")}

            <span className="ml-2 px-2 py-0.5 text-[10px] bg-amber-500/20 text-amber-400 rounded-full font-normal">
              Phase 5.0
            </span>
          </h3>
          <p className="text-xs text-gray-500 mt-0.5">{i18n.t("MultiTimeframePanel.r92_cc48")}
            {TIMEFRAME_LABELS['1m']}-{TIMEFRAME_LABELS['1d']}
          </p>
        </div>
        ...
        <button
          ...
          className="px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-xs text-gray-400 hover:text-gray-200 transition-colors">{i18n.t("MultiTimeframePanel.r92_bdf0")}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">{i18n.t("MultiTimeframePanel.r92_e606")}
                {signal.fusedStrength.toFixed(0)}{i18n.t("MultiTimeframePanel.r92_3c13")}{(signal.fusedConfidence * 100).toFixed(0)}%
              </div>
            </div>
          </div>
      ...
      <div className="mb-5 space-y-2.5">
        <h4 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wide">{i18n.t("MultiTimeframePanel.r92_6e48")}
      ...
      <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-700/30 mb-4">
        <h4 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wide">{i18n.t("MultiTimeframePanel.r92_f51c")}
      ...
      <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-700/30">
          <h4 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wide">{i18n.t("MultiTimeframePanel.r92_93c6")}
...
: FusionResult {
  ...
  if (mode === 'majority') {
    ...
    for (const s of enabledSignals) {
      ...
      if (s.direction === 'BUY') buyWeight += w * s.strength;else
      if (s.direction === 'SELL') sellWeight += w * s.strength;
    }
