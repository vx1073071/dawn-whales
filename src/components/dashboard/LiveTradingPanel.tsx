  ...
  return (
    <div className={`bg-gray-900 rounded-xl border border-gray-800 p-5 ${className ?? ''}`}>
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-lg font-bold text-white">{i18n.t("LiveTradingPanel.r92_b041")}
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            {isRunning ? i18n.t('LiveTradingPanel.k3') : i18n.t('LiveTradingPanel.k4')} · {activeOrderCount}{i18n.t("LiveTradingPanel.r92_39a8")}{paperPositions.length}{i18n.t("LiveTradingPanel.r92_89b8")}
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            }>{i18n.t("LiveTradingPanel.r92_1cf3")}
      ...
      <div className="mb-5 bg-red-500/10 border border-red-500/30 rounded-lg p-4">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-red-400/70 text-xs mt-1">{i18n.t("LiveTradingPanel.r92_8c2d")}
            ...
            <div className="flex gap-2">
              ...
              className="px-3 py-1.5 bg-gray-800 rounded-lg text-xs text-gray-400">{i18n.t("LiveTradingPanel.r92_45f1")}


            </button>
              <button
              onClick={handleEmergencyStop}
              className="px-3 py-1.5 bg-red-600 rounded-lg text-xs text-white font-bold">{i18n.t("LiveTradingPanel.r92_2c0d")}
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        ...
        { label: i18n.t('LiveTradingPanel.k9'), value: `${totalRealizedPnl >= 0 ? '+' : ''}$${totalRealizedPnl.toLocaleString()}`, color: totalRealizedPnl >= 0 ? 'text-emerald-400' : 'text-red-400' }] as
        const).map((card) =>
      ...
      <div className="flex gap-1 mb-4 bg-gray-800/40 rounded-lg p-1">
        ...
        { key: 'audit', label: i18n.t('LiveTradingPanel.k12') }] as
        const).map((tab) =>
        <button
          key={tab.key}
      ...
      <div className="space-y-4">
          ...
          <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-700/30">
            <h4 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wide">{i18n.t("LiveTradingPanel.r92_42e9")}
            ...
            { label: i18n.t('LiveTradingPanel.k18'), value: `${reconciliation.driftPercent}%`, color: reconciliation.driftPercent > 5 ? 'text-red-400' : 'text-emerald-400' }] as
            const).map((c) =>
          ...
          <div className="mt-3 pt-3 border-t border-gray-700/30">
            ...
            <div key={m.symbol} className="text-[10px] text-yellow-400/70">
                    {m.symbol}{i18n.t("LiveTradingPanel.r92_f925")}{m.paperQty}{i18n.t("LiveTradingPanel.r92_ab12")}{m.liveQty}
                  </div>
            )}
              </div>
          }
