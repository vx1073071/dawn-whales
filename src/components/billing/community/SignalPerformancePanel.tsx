...
}: {value: number;label: string;max: number;unit: string;colorRanges: {min: number;max: number;color: string;}[];}) {
      ...
      {returns.map((r) => {
        ...
        return (
          <div key={r.month} className="p-2 rounded-md text-center min-w-[70px]" style={{ background: bg }}>
            <div className="text-[9px] text-gray-500">{r.month.slice(5)}{i18n.t("SignalPerformancePanel.r92_aaf7")}</div>
            <div className={`text-xs font-bold ${r.return_ >= 0 ? 'text-green-400' : 'text-red-400'}`}>
              {r.return_ >= 0 ? '+' : ''}{r.return_}%
            </div>
            <div className="text-[9px] text-gray-600">
              {r.signals}{i18n.t("SignalPerformancePanel.r92_6772")}{r.winRate}%
            </div>
          </div>);
      ...
      <div className="p-5 border-b border-white/5">
        <div className="flex items-center justify-between">
          <div>
            ...
            {creatorName && <p className="text-gray-500 text-xs mt-0.5">{creatorName}{i18n.t("SignalPerformancePanel.r92_805e")}</p>}
          </div>
          {/* Grade Badge */}
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-[#111119] border border-white/5 rounded-xl p-4 text-center">
            ...
            <div className="text-[10px] text-gray-600">{perf.closedSignals}{i18n.t("SignalPerformancePanel.r92_9657")}</div>
          </div>
          <div className="bg-[#111119] border border-white/5 rounded-xl p-4 text-center">
        ...
        <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
          <h3 className="text-gray-300 font-semibold text-sm mb-3">{i18n.t("SignalPerformancePanel.r92_a8b5")}</h3>
          <EquityCurve data={perf.equityCurve} height={140} />
          <div className="flex justify-between mt-2 text-[10px] text-gray-600">
            <span>{i18n.t("SignalPerformancePanel.r92_5e22")}</span>
        ...
        {/* ── Monthly Heatmap ───────────────────────────────────────────── */}
        <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
          <h3 className="text-gray-300 font-semibold text-sm mb-3">{i18n.t("SignalPerformancePanel.r92_49ac")}</h3>
        ...
        <div className="bg-[#111119] border border-white/5 rounded-xl overflow-hidden">
          <div className="px-5 py-3 border-b border-white/5 flex items-center justify-between">
            <h3 className="text-gray-300 font-semibold text-sm">{i18n.t("SignalPerformancePanel.r92_472c")}</h3>
          ...
          <div className="divide-y divide-white/5 max-h-[400px] overflow-y-auto">
            ...
            <div className="p-10 text-center text-gray-600 text-sm">{i18n.t("SignalPerformancePanel.r92_660a")}
              {signalFilter === 'WIN' ? i18n.t('SignalPerformancePanel.k17') : signalFilter === 'LOSS' ? i18n.t('SignalPerformancePanel.k18') : 'components.positions'}{i18n.t("SignalPerformancePanel.r92_3ca6")}
            </div>
            }
          </div>
        </div>
