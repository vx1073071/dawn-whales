  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, color: '#9CA3AF', marginBottom: 16 }}>{i18n.t("GrowthPanel.r92_7a47")}
          <strong style={{ color: '#D4A853' }}>{i18n.t('GrowthPanel.k39')}</strong>{i18n.t("GrowthPanel.r92_3ef1")}
        </div>
        ...
        <div style={{ fontSize: 11, color: '#6B7280' }}>{i18n.t("GrowthPanel.r92_12ee")}
  ...
  return (
    <div style={theme}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#F9FAFB' }}>{i18n.t("GrowthPanel.r92_1e54")}

          </h2>
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#9CA3AF' }}>{i18n.t("GrowthPanel.r92_edd4")}
