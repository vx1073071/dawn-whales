  ...
  return (
    <div className={`h-full flex flex-col bg-[#0A0A10] text-white ${className}`}>
      <div style={{ padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
        <h2 style={{ fontSize: 16, fontWeight: 800, color: '#D4A853', margin: 0 }}>{i18n.t("FullPipelineUI.r92_0c49")}</h2>
      ...
      <div className="flex-1 overflow-y-auto p-4">
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 700, color: s.done ? '#22C55E' : '#E2E8F0' }}>{i18n.t("FullPipelineUI.r92_58be")}{s.step}{i18n.t('FullPipelineUI.k0')}{s.title}</div>
        ...
        <div style={{ marginTop: 16, padding: 16, background: 'rgba(212,168,83,0.05)', border: '1px solid rgba(212,168,83,0.1)', borderRadius: 12 }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#D4A853', marginBottom: 8 }}>{i18n.t("FullPipelineUI.r92_75af")}</div>
