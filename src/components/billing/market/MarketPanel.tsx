  ...
  return (
    <div className={`h-full flex flex-col bg-[#0A0A10] text-white ${className}`}>
      ...
      <div style={{ padding: '8px 12px', borderBottom: '1px solid rgba(255,255,255,0.04)', display: 'flex', gap: 4, flexWrap: 'wrap' }}>
        ...
        style={{ padding: '4px 10px', fontSize: 10, fontWeight: 600, borderRadius: 6, background: !selectedMarket ? 'rgba(212,168,83,0.15)' : 'transparent', color: !selectedMarket ? '#D4A853' : '#64748B', border: !selectedMarket ? '1px solid rgba(212,168,83,0.3)' : '1px solid rgba(255,255,255,0.06)', cursor: 'pointer' }}>{i18n.t("MarketPanel.r92_0d3b")}
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        ...
        <div key={f.id} className="pb-card" style={{ padding: 12 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: 9, color: '#475569', fontFamily: 'monospace' }}>{f.usage.toLocaleString()}{i18n.t("MarketPanel.r92_8e27")}</span>
            </div>
          </div>
        )}
        ...
        <div key={t.id} className="pb-card" style={{ padding: 12 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: 9, color: '#475569' }}>{t.usage.toLocaleString()}{i18n.t("MarketPanel.r92_9c1e")}</span>
            </div>
          </div>
        )}
