    ...
    <div className={`h-full flex flex-col bg-[#0D0D14] text-white ${className}`}>
      ...
      <div className="p-5 border-b border-white/5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex bg-white/[0.04] rounded-lg p-0.5">
            ...
            className={`px-3 py-1.5 rounded-md text-xs font-medium ${channel === 'stable' ? 'bg-[#C9A046]/20 text-[#D4A853]' : 'text-gray-600'}`}>{i18n.t("AutoUpdatePanel.r92_e781")}
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <div className="bg-[#111119] border border-[#C9A046]/20 rounded-xl p-5">
          ...
          className="w-full py-2.5 rounded-lg bg-[#C9A046] hover:bg-[#D4A853] text-black font-semibold text-sm transition-colors">{i18n.t("AutoUpdatePanel.r92_18f1")}
            {updateInfo.version}
            </button>
          </div>
        }
        ...
        <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
          ...
          className="w-full py-2.5 rounded-lg bg-green-500 hover:bg-green-400 text-black font-semibold text-sm transition-colors">{i18n.t("AutoUpdatePanel.r92_2d5d")}
        ...
        <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 text-center">
          ...
          className="block mx-auto mt-2 px-4 py-1.5 rounded bg-red-500/10 text-red-400 text-xs font-semibold">{i18n.t("AutoUpdatePanel.r92_ebcf")}
