...
function EfficientFrontier({ points }: {points: PortfolioPoint[];}) {
  ...
  return (
    <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} className="w-full">
      ...
      {/* Labels */}
      <text x={w / 2} y={h - 2} fill="#64748b" fontSize="9" textAnchor="middle">{i18n.t("PortfolioOptimizationPanel.r92_2cf6")}</text>
      <text x={8} y={h / 2} fill="#64748b" fontSize="9" textAnchor="middle" transform={`rotate(-90,8,${h / 2})`}>{i18n.t("PortfolioOptimizationPanel.r92_6eb8")}</text>
      {/* Frontier curve */}
    ...
    <div className={`h-full flex flex-col bg-[#0D0D14] text-white ${className}`}>
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
            <h4 className="text-gray-300 font-semibold text-sm mb-3">{i18n.t("PortfolioOptimizationPanel.r92_a4ce")}</h4>
        ...
        {tab === 'risk' &&
        <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
            <h4 className="text-gray-300 font-semibold text-sm mb-3">{i18n.t("PortfolioOptimizationPanel.r92_fbbe")}</h4>
            <RiskBudgetPie budget={riskBudget} />
            <div className="mt-3 p-3 bg-yellow-500/5 border border-yellow-500/10 rounded-lg text-[10px] text-yellow-400 text-center">{i18n.t("PortfolioOptimizationPanel.r92_5f28")}
        ...
        <div className="bg-[#111119] border border-white/5 rounded-xl overflow-hidden">
            <div className="px-5 py-3 border-b border-white/5 text-gray-300 font-semibold text-sm">{i18n.t("PortfolioOptimizationPanel.r92_0b23")}</div>
