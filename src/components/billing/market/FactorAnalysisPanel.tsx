      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        {tab === 'icir' && (
          <div className="bg-[#111119] border border-white/5 rounded-xl overflow-hidden">
            <div className="px-5 py-3 border-b border-white/5 text-gray-300 font-semibold text-sm">📊 因子 IC / IR</div>
              ...
              <tbody className="divide-y divide-white/5">
                {factors.map(f => (
                  <tr key={f.name} className="hover:bg-white/[0.02]">
                    ...
                    <td className="px-4 py-2.5 text-right text-gray-400">{f.decay}月</td>
        ...
        {tab === 'exposure' && (
          <div className="bg-[#111119] border border-white/5 rounded-xl overflow-hidden">
            <div className="px-5 py-3 border-b border-white/5 text-gray-300 font-semibold text-sm">🔥 因子暴露热力图</div>
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-white/[0.02] text-gray-500">
        ...
        {tab === 'radar' && (
          <div className="space-y-5">
            <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
              <h4 className="text-gray-300 font-semibold text-sm mb-3">🎯 多策略对比雷达图</h4>
            ...
            <div className="bg-[#111119] border border-white/5 rounded-xl overflow-hidden">
              <div className="px-5 py-3 border-b border-white/5 text-gray-300 font-semibold text-sm">📋 策略对比明细</div>
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-white/[0.02] text-gray-500">
