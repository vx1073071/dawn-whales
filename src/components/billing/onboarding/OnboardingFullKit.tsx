...
function FactorStoryCard({ story }: {story: FactorStory;}) {
  return (
    <div style={{ padding: '16px 18px', borderRadius: 12, background: '#1F2937', border: '1px solid #374151' }}>
      ...
      <div style={{ padding: '8px 12px', borderRadius: 8, background: '#111827', fontSize: 12, color: '#818CF8' }}>{i18n.t("OnboardingFullKit.r92_3462")}
        {story.example}
      </div>
    </div>);
    ...
    <div style={{ padding: '12px 16px', borderRadius: 10, background: '#1F2937', border: '1px solid #374151', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: 11, color: '#9CA3AF', marginTop: 2 }}>
          {story.initial} → {story.final}{i18n.t("OnboardingFullKit.r92_bc61")}{story.maxDrawdown}{i18n.t("OnboardingFullKit.r92_1417")}{story.winRate}
        </div>
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, color: '#D1D5DB', marginBottom: 6 }}>
        💡 <strong>{i18n.t('OnboardingFullKit.k107')}</strong>{i18n.t("OnboardingFullKit.r92_12e3")}
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
        <div style={{ fontSize: 11, color: '#EF4444' }}>{i18n.t("OnboardingFullKit.r92_6289")}

        </div>
        <div style={{ fontSize: 11, color: '#34D399' }}>{i18n.t("OnboardingFullKit.r92_e977")}

        </div>
        <div style={{ fontSize: 11, color: '#EF4444' }}>{i18n.t("OnboardingFullKit.r92_566d")}

        </div>
        <div style={{ fontSize: 11, color: '#34D399' }}>{i18n.t("OnboardingFullKit.r92_b244")}
  ...
  return (
    <div style={theme}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div>
          <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#F9FAFB' }}>{i18n.t("OnboardingFullKit.r92_b034")}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 24 }}>
          ...
          }}>{i18n.t("OnboardingFullKit.r92_477b")}
          ...
          }}>{i18n.t("OnboardingFullKit.r92_0a3f")}
...
function OnboardingIntro({ onStart }: {onStart: () => void;}) {
  return (
    <div style={{ textAlign: 'center', padding: '40px 20px' }}>
      ...
      <div style={{ fontSize: 20, fontWeight: 700, color: '#F9FAFB', marginBottom: 8 }}>{i18n.t("OnboardingFullKit.r92_663b")}

      </div>
      <div style={{ fontSize: 14, color: '#9CA3AF', marginBottom: 32, lineHeight: 1.8 }}>{i18n.t("OnboardingFullKit.r92_5d55")}
        <br />{i18n.t("OnboardingFullKit.r92_505b")}
      ...
      <button
        ...
        }}>{i18n.t("OnboardingFullKit.r92_524b")}


      </button>

      <div style={{ marginTop: 16, fontSize: 12, color: '#6B7280' }}>{i18n.t("OnboardingFullKit.r92_b5bc")}
...
}: {onComplete: () => void;sliderVal: number;setSliderVal: (v: number) => void;selectedPreset: string | null;setSelectedPreset: (v: string) => void;}) {
  return (
    <div>
      <FriendlyErrorBanner />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
        {/* Left: presets */}
        <div>
          <div style={{ fontSize: 14, fontWeight: 600, color: '#D1D5DB', marginBottom: 10 }}>{i18n.t("OnboardingFullKit.r92_afa8")}
        ...
        {/* Right: slider */}
        <div>
          <div style={{ fontSize: 14, fontWeight: 600, color: '#D1D5DB', marginBottom: 10 }}>{i18n.t("OnboardingFullKit.r92_f200")}

          </div>
          <div style={{ padding: '16px', borderRadius: 12, background: '#1F2937', border: '1px solid #374151' }}>
            <div style={{ fontSize: 12, color: '#9CA3AF', marginBottom: 4 }}>{i18n.t("OnboardingFullKit.r92_94b6")}
          ...
          {sliderVal < 5 &&
          <div style={{ marginTop: 8, padding: '8px 12px', borderRadius: 8, background: '#EF444418', border: '1px solid #EF444433', fontSize: 11, color: '#FCA5A5' }}>{i18n.t("OnboardingFullKit.r92_cc30")}
      ...
      <button
        ...
        }}>{i18n.t("OnboardingFullKit.r92_3dbe")}
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={{ marginTop: 8, fontSize: 12, color: '#6B7280', textAlign: 'center' }}>{i18n.t("OnboardingFullKit.r92_62cf")}
      ...
      <div>
          ...
          <div style={{ marginTop: 12, padding: '12px 16px', borderRadius: 10, background: '#1F2937', border: '1px solid #374151', fontSize: 13, color: '#D1D5DB' }}>
            ...
            <div style={{ lineHeight: 1.8 }}>{i18n.t("OnboardingFullKit.r92_a8dd")}
            <br />{i18n.t("OnboardingFullKit.r92_83e1")}
...
function CompletionScreen() {
  return (
    <div style={{ textAlign: 'center', padding: '40px 20px' }}>
      <div style={{ fontSize: 56, marginBottom: 16 }}>🎉</div>
      <div style={{ fontSize: 22, fontWeight: 700, color: '#F9FAFB', marginBottom: 8 }}>{i18n.t("OnboardingFullKit.r92_43cd")}

      </div>
      <div style={{ fontSize: 14, color: '#9CA3AF', marginBottom: 24, lineHeight: 1.8 }}>{i18n.t("OnboardingFullKit.r92_357b")}
        <br />{i18n.t("OnboardingFullKit.r92_3ef2")}
