...
function TierCard({ tier, isActive }: {tier: RevenueTier;isActive: boolean;}) {
  return (
    <div style={{
      ...
      <div style={{ marginTop: 8, padding: '4px 10px', borderRadius: 6, background: '#374151', fontSize: 11, color: '#6B7280' }}>{i18n.t("USDTPaymentPanel.r92_cca7")}
        {tier.commission}%
      </div>
    </div>);
  ...
  return (
    <div>
      ...
      <div style={{ padding: '20px', borderRadius: 12, background: '#111827', border: '1px solid #1F2937' }}>
          <div style={{ fontSize: 13, color: '#D1D5DB', marginBottom: 12 }}>{i18n.t("USDTPaymentPanel.r92_9d20")}
          <strong style={{ color: '#F59E0B' }}>USDT-TRC20</strong>{i18n.t('USDTPaymentPanel.k1')}<strong>10 USDT</strong>{i18n.t("USDTPaymentPanel.r92_02e2")}
        </div>
          <div style={{ padding: '16px', borderRadius: 10, background: '#1F2937', border: '1px solid #374151', textAlign: 'center', marginBottom: 16 }}>
            ...
            <button style={{ padding: '6px 16px', borderRadius: 6, border: '1px solid #374151', background: '#111827', color: '#818CF8', fontSize: 12, cursor: 'pointer' }}>{i18n.t("USDTPaymentPanel.r92_e290")}

          </button>
          </div>
          <div style={{ padding: '8px 12px', borderRadius: 8, background: '#F59E0B08', border: '1px solid #F59E0B33', fontSize: 11, color: '#FBBF24' }}>{i18n.t("USDTPaymentPanel.r92_3777")}
      ...
      <div style={{ padding: '20px', borderRadius: 12, background: '#111827', border: '1px solid #1F2937' }}>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ fontSize: 11, color: '#6B7280', marginTop: 4 }}>{i18n.t("USDTPaymentPanel.r92_572f")}
            <span style={{ color: '#D1D5DB' }}>{amount ? Number(amount) - 1 : '—'} USDT</span>
            </div>
          </div>
        ...
        }}>{i18n.t("USDTPaymentPanel.r92_c0ac")}
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 14, fontWeight: 600, color: '#D1D5DB', marginBottom: 12 }}>{i18n.t("USDTPaymentPanel.r92_59fa")}
      ...
      <div style={{ padding: '14px 16px', borderRadius: 10, background: '#111827', border: '1px solid #1F2937' }}>
        <div style={{ fontSize: 12, color: '#D1D5DB', marginBottom: 6 }}>{i18n.t("USDTPaymentPanel.r92_478e")}
          <strong style={{ color: '#D4A853' }}>{i18n.t("USDTPaymentPanel.r92_9378")}</strong>{i18n.t("USDTPaymentPanel.r92_d12e")}
        </div>
  ...
  return (
    <div style={theme}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#F9FAFB' }}>{i18n.t("USDTPaymentPanel.r92_b09b")}

          </h2>
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#9CA3AF' }}>{i18n.t("USDTPaymentPanel.r92_6fbf")}
