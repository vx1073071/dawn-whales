  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 16, padding: '14px 16px', borderRadius: 10, background: '#111827', border: '1px solid #1F2937' }}>
        ...
        <div style={{ fontSize: 11, color: '#6B7280' }}>{i18n.t("P2PBlacklistPanel.r92_65fe")}
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        <div style={{ fontSize: 13, color: '#D1D5DB' }}>{i18n.t("P2PBlacklistPanel.r92_3f44")}
          {BLACKLIST.filter((b) => b.status === 'active').length}{i18n.t("P2PBlacklistPanel.r92_b653")}
        </div>
        <button style={{
          padding: '6px 16px', borderRadius: 6, border: '1px solid #EF4444', background: '#EF444418',
          color: '#FCA5A5', fontSize: 12, cursor: 'pointer'
        }}>{i18n.t("P2PBlacklistPanel.r92_8a3b")}
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
          ...
          <tbody>
            ...
            <tr key={b.id} style={{ borderBottom: '1px solid #1F2937' }}>
                ...
                }}>{i18n.t("P2PBlacklistPanel.r92_2351")}
  ...
  return (
    <div style={theme}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#F9FAFB' }}>{i18n.t("P2PBlacklistPanel.r92_3658")}

          </h2>
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#9CA3AF' }}>{i18n.t("P2PBlacklistPanel.r92_beec")}
