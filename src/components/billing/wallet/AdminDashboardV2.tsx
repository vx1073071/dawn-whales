        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex bg-white/[0.04] rounded-lg p-0.5">
            <button onClick={() => setTab('overview')}
              className={`px-3 py-1.5 rounded-md text-xs font-medium ${tab === 'overview' ? 'bg-[#C9A046]/20 text-[#D4A853]' : 'text-gray-600'}`}>
              📊 概览
            </button>
            <button onClick={() => setTab('audit')}
              className={`px-3 py-1.5 rounded-md text-xs font-medium ${tab === 'audit' ? 'bg-[#C9A046]/20 text-[#D4A853]' : 'text-gray-600'}`}>
              📋 审计
            </button>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="bg-[#111119] border border-white/5 rounded-xl p-3 text-center">
            <div className="text-[10px] text-gray-600">API 延迟</div>
          ...
          <div className="bg-[#111119] border border-white/5 rounded-xl p-3 text-center">
            <div className="text-[10px] text-gray-600">24h 错误率</div>
        ...
        {tab === 'overview' && (
          <>
            ...
            <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
              <h3 className="text-gray-300 font-semibold text-sm mb-3">⚡ 快捷操作</h3>
            ...
            {/* ── Status Summary ────────────────────────────────────────── */}
            <div className="bg-[#111119] border border-white/5 rounded-xl p-5">
              <h3 className="text-gray-300 font-semibold text-sm mb-3">✅ 系统状态</h3>
              ...
              <div className="mt-3 text-center">
                <span className="text-xs text-green-400 font-semibold">🟢 所有系统正常 — v1.7.0 GA Ready</span>
              </div>
            </div>
          </>
        )}
