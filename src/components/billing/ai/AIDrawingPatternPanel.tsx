...
}: {activeTool: string | null;setActiveTool: (t: string | null) => void;drawings: Drawing[];setDrawings: (d: Drawing[]) => void;}) {
  ...
  return (
    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', padding: '8px 0' }}>
      ...
      <button
        ...
        }}>{i18n.t("AIDrawingPatternPanel.r92_5bd7")}
...
}: {drawings: Drawing[];setDrawings: (d: Drawing[]) => void;activeTool: string | null;}) {
...
}: {pattern: Pattern;onAnnotate: (id: string) => void;onCorrect: (id: string) => void;}) {
    ...
    <div
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <button
          ...
          }}>{i18n.t("AIDrawingPatternPanel.r92_d874")}
        ...
        <button
          ...
          }}>{i18n.t("AIDrawingPatternPanel.r92_7aca")}
...
export default function AIDrawingPatternPanel() {
  ...
  const filteredPatterns = useMemo(() => {
    ...
    if (sortBy === 'confidence') list = [...list].sort((a, b) => b.confidence - a.confidence);else
  ...
  return (
    <div style={theme}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#F9FAFB' }}>{i18n.t("AIDrawingPatternPanel.r92_1c8a")}

          </h2>
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#9CA3AF' }}>{i18n.t("AIDrawingPatternPanel.r92_dc50")}
        ...
        <div style={{ display: 'flex', gap: 4, background: '#111827', borderRadius: 10, padding: 4 }}>
          <button
            ...
            }}>{i18n.t("AIDrawingPatternPanel.r92_b061")}
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer', transition: 'all 0.15s'
            }}>{i18n.t("AIDrawingPatternPanel.r92_3985")}

            {patterns.filter((p) => p.annotated).length}/{patterns.length})
          </button>
        </div>
      </div>
      ...
      <>
          ...
          <div style={{ marginTop: 12 }}>
            <div style={{ fontSize: 13, color: '#9CA3AF', marginBottom: 8 }}>{i18n.t("AIDrawingPatternPanel.r92_984c")}
            {drawings.length}{i18n.t("AIDrawingPatternPanel.r92_bb98")}
          </div>
            <div style={{ fontSize: 11, color: '#6B7280' }}>{i18n.t("AIDrawingPatternPanel.r92_22b7")}
      ...
      <>
        ...
        }}>{i18n.t("AIDrawingPatternPanel.r92_a18c")}
