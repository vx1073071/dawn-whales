...
const I18N: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    footer: 'QUANT MOO v17.9 收费目录 · 永久生效 · 纯USDT无KYC',
    close: '关闭',
  },
  en: {
