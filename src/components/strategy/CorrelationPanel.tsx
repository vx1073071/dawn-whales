  ...
  return (
    <div className="bg-[#1a1a25] border border-white/5 rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-white font-semibold text-sm">📊 策略相关性矩阵</h3>
      ...
      <div className="mb-3">
        <div className="text-gray-400 text-[11px] font-medium mb-2">🔴 最高相关性 (风险集中)</div>
      ...
      <div>
        <div className="text-gray-400 text-[11px] font-medium mb-2">🟢 最低相关性 (分散化机会)</div>
        <div className="space-y-1">
