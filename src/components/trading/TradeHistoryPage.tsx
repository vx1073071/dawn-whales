...
const MOCK_TRADES: TradeRecord[] = [
  ...
  { tradeId: 'T006', orderId: 'O006', code: 'MSFT', name: "components.mockStockMicrosoft", side: 'BUY', qty: 60, price: 405.00, filledQty: 60, filledPrice: 405.05, commission: 2.43, pnl: 0, pnlPct: 0, tradeTime: '2024-03-12 09:20:45', strategyId: 'strategy-003', strategyName: "components.strategyValueInvest", remark: i18n.t('TradeHistoryPage.k0') },
  ...
  { tradeId: 'T008', orderId: 'O008', code: 'AVGO', name: "components.mockStockBroadcom", side: 'BUY', qty: 30, price: 1200.00, filledQty: 30, filledPrice: 1200.50, commission: 3.60, pnl: 0, pnlPct: 0, tradeTime: '2024-04-05 10:10:22', strategyId: 'strategy-002', strategyName: "components.strategyMomentumRotate", remark: i18n.t('TradeHistoryPage.k1') },
