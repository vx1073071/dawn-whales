...
export const LLMCreatorConfigPanel: React.FC<LLMCreatorConfigPanelProps> = ({
  ...
  return (
    <div style={styles.container}>
      <h3 style={styles.title}>{i18n.t("LLMCreatorConfigPanel.r92_173e")}</h3>

      {/* Balance */}
      <div style={styles.balanceRow}>
        <span>{i18n.t("LLMCreatorConfigPanel.r92_f492")}</span>
      ...
      <div style={styles.section}>
          <div style={styles.sectionTitle}>
            {currentProvider.logo} {currentProvider.name}{i18n.t("LLMCreatorConfigPanel.r92_bc85")}
        </div>
        ...
        <table style={styles.costTable}>
          <thead>
            <tr style={styles.tableHeaderRow}>
              ...
              <th style={styles.th}>{i18n.t("LLMCreatorConfigPanel.r92_ef9f")}</th>
          ...
          <tbody>
            ...
            <tr key={est.tier} style={styles.tableRow}>
                ...
                <td style={styles.td}>{est.agentCount}{i18n.t("LLMCreatorConfigPanel.r92_54e5")}</td>
      ...
      {promoExpired &&
      <div style={styles.promoWarning}>{i18n.t("LLMCreatorConfigPanel.r92_10d6")}
        {promoExpiryDate}{i18n.t("LLMCreatorConfigPanel.r92_f933")}
      </div>
      }
      ...
      <div style={styles.section}>
        <div
          ...
          <span>{i18n.t("LLMCreatorConfigPanel.r92_24d5")}</span>
