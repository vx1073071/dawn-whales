      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            {healthyCount}/{sources.length} 源正常 · 均延迟 {avgLatency}ms · 覆盖率 {avgCoverage}%
          </p>
        </div>
      </div>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-[10px] px-1.5 py-0.5 rounded ${
                    ...
                    价差 {quote.spreadPercent.toFixed(2)}%
                  </span>
                </div>
              </div>
                  ...
                  {quote.sources.map(s => {
                    ...
                    return (
                      <tr key={s.source} className="border-b border-gray-700/20 text-gray-400">
                        ...
                        <td className="py-1.5 pr-3 text-right">{(s.volume / 10000).toFixed(0)}万</td>
