...
export const MarketplaceDetail: React.FC<MarketplaceDetailProps> = ({ strategyId: _id, onClose, className }) => {
  ...
  return (
    <div className={`bg-gray-900 rounded-xl border border-gray-800 p-5 ${className ?? ''}`}>
      {/* Back button */}
      {onClose &&
      <button onClick={onClose} className="text-xs text-gray-500 hover:text-gray-300 mb-3">{i18n.t("MarketplaceDetail.r92_996c")}
      ...
      <div className="flex items-start justify-between mb-5">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-[10px] text-gray-600">({detail.reviewCount}{i18n.t("MarketplaceDetail.r92_d33b")}</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-gray-600">{detail.subscribers}{i18n.t("MarketplaceDetail.r92_f3b1")}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
        ...
        [i18n.t('MarketplaceDetail.k13'), detail.createdAt, 'text-gray-500']] as
